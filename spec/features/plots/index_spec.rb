...
RSpec.describe "Plots Index Page" do
  before :each do
    ...
    @plant_1 = Plant.create!(name: "Black Krim", description: "Tomatoes", days_to_harvest: 65)
    @plant_2 = Plant.create!(name: "Cherokee Pink", description: "Tomatoes", days_to_harvest: 65)
    @plant_3 = Plant.create!(name: "Sun Gold", description: "Tomatoes", days_to_harvest: 70)
    @plant_4 = Plant.create!(name: "Jalapeños", description: "Chiles", days_to_harvest: 85)
    @plant_5 = Plant.create!(name: "Thai Hot", description: "Chiles", days_to_harvest: 90)
